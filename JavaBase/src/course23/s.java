...
public class s {
	...
	public static void main(String[] args) {
		...
		for (int g = 0; g == 9; g++) {
			...
			System.out.println("入れ替え位置を入力。[0][0]の左側");
			int a = stdIn.nextInt();
			
			System.out.println("入れ替え位置を入力。[0][0]の右側");
			int b = stdIn.nextInt();
			
			System.out.println("入れ替え先を入力。[0][0]の左側");
			int c = stdIn.nextInt();
			
			System.out.println("入れ替え先を入力。[0][0]の右側");
			int d = stdIn.nextInt();
